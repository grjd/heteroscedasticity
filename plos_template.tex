...
Not coincidentally Eklund \citep{eklund2017bayesian} has proposed to include heteroscedasticity in the vanilla GLM approach to fMRI data. %modeling heterocesdaticity
